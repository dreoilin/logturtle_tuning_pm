/*
 * File: F2837x_TUNING.c
 *
 * Code generated for Simulink model 'F2837x_TUNING'.
 *
 * Model version                  : 1.1
 * Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
 * C/C++ source code generated on : Thu Mar  5 14:34:05 2026
 *
...
void F2837x_TUNING_step(void)
{
   ...
   */
  {
    EPwm1Regs.TBPRD = (uint16_T)(F2837x_TUNING_P.Constant_Value);
  }

  {
    EPwm1Regs.DBRED.bit.DBRED = (uint16_T)(F2837x_TUNING_P.Constant1_Value);
  }

  {
    EPwm1Regs.DBFED.bit.DBFED = (uint16_T)(F2837x_TUNING_P.Constant1_Value);
  }
}

/* Model initialize function */
void F2837x_TUNING_initialize(void)
{
  ...
  /*** Initialize ePWM1 modules ***/
  {
    ...
    EPwm1Regs.TBPRD = 200U;            // Time Base Period Register
    ...
    EPwm1Regs.CMPA.bit.CMPA = 100U;    // Counter Compare A Register
...
void F2837x_TUNING_terminate(void)
{
