...
void TX_PM_MODEL_d3b57d61_1_dae ( NeDae * * dae , const NeModelParameters *
...
ne_dae_create ( dae , TX_PM_MODEL_d3b57d61_1_dae_ds ( ne_allocator ) , NULL ,
FALSE , rtpValues , * solverParams , * modelParams , linear_algebra_ptr ,
NULL , NULL , NULL , ne_allocator , NULL , DAEMON_CHOICE_NONE , NULL ) ; }
