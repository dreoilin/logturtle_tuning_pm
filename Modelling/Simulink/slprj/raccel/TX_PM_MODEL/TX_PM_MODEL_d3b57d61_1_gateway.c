...
#endif
#include "nesl_rtw.h"
#include "TX_PM_MODEL_d3b57d61_1.h"
#include "TX_PM_MODEL_d3b57d61_1_gateway.h"
void TX_PM_MODEL_d3b57d61_1_gateway ( void ) { NeModelParameters modelparams
= { ( enum NeSolverTypeTag ) 0 , 0.001 , 0.001 , 0.001 , TRUE , FALSE , (
enum NeModifyAbsTolTag ) 2 , 0.001 , 0.0 , FALSE , FALSE , FALSE , ( enum
SscLoggingSettingTag ) 0 , 689774097.0 , FALSE , FALSE , FALSE } ;
...
sizeof ( outputparameters_init [ 0 ] ) ; } TX_PM_MODEL_d3b57d61_1_dae ( & dae
, & modelparams , & solverparams ) ; nesl_register_simulator_group (
"TX_PM_MODEL/Solver Configuration_1" , 1 , & dae , & solverparams , &
