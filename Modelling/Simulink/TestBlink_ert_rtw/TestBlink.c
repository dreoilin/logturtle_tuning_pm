...
void TestBlink_step(void)
{
  ...
  /*-- Update CMPA value for ePWM2 --*/
  {
    EPwm2Regs.CMPA.bit.CMPA = (uint16_T)((uint32_T)EPwm2Regs.TBPRD *
      TestBlink_P.Constant_Value * 0.01);
  }

  /*-- UpdateTBPAHR --*/
  {
    extern int16_T MEP_ScaleFactor;
    real_T TBPRDf = 5.0E-7;
    TBPRDf *= 100000000;
    TBPRDf -= 50;
    TBPRDf *= 65536;
    EPwm2Regs.TBPRDHR = (uint16_T)TBPRDf;
  }
  ...
  /*-- Update CMPBHR --*/
  {
    extern int16_T MEP_ScaleFactor;
    real_T CMPBf = 75.0;
    CMPBf *= EPwm2Regs.TBPRD;
    CMPBf *= 0.01;
    CMPBf -= EPwm2Regs.CMPB.bit.CMPB;
    CMPBf *= 65536;
    EPwm2Regs.CMPB.bit.CMPBHR = (uint16_T)CMPBf;
  }

  /*-- Update CMPAHR --*/
  {
    extern int16_T MEP_ScaleFactor;
    real_T CMPAf = TestBlink_P.Constant_Value;
    CMPAf *= EPwm2Regs.TBPRD;
    CMPAf *= 0.01;
    CMPAf -= EPwm2Regs.CMPA.bit.CMPA;
    CMPAf *= 65536;
    EPwm2Regs.CMPA.bit.CMPAHR = (uint16_T)CMPAf;
  }
   ...
   */
  rtb_Sum = TestBlink_P.Constant1_Value - TestBlink_P.Constant_Value;

  /* S-Function (c2802xpwm): '<Root>/ePWM2' */

  /*-- Update CMPA value for ePWM3 --*/
  {
    EPwm3Regs.CMPA.bit.CMPA = (uint16_T)((uint32_T)EPwm3Regs.TBPRD * rtb_Sum *
      0.01);
  }
  ...
  /*-- UpdateTBPAHR --*/
  {
    ...
    TBPRDf -= 50;
    TBPRDf *= 65536;
    EPwm3Regs.TBPRDHR = (uint16_T)TBPRDf;
  }
  ...
  /*-- Update CMPBHR --*/
  {
    extern int16_T MEP_ScaleFactor;
    real_T CMPBf = 75.0;
    CMPBf *= EPwm3Regs.TBPRD;
    CMPBf *= 0.01;
    CMPBf -= EPwm3Regs.CMPB.bit.CMPB;
    CMPBf *= 65536;
    EPwm3Regs.CMPB.bit.CMPBHR = (uint16_T)CMPBf;
  }

  /*-- Update CMPAHR --*/
  {
    extern int16_T MEP_ScaleFactor;
    real_T CMPAf = rtb_Sum;
    CMPAf *= EPwm3Regs.TBPRD;
    CMPAf *= 0.01;
    CMPAf -= EPwm3Regs.CMPA.bit.CMPA;
    CMPAf *= 65536;
    EPwm3Regs.CMPA.bit.CMPAHR = (uint16_T)CMPAf;
  }
}

/* Model initialize function */
void TestBlink_initialize(void)
{
  ...
  /*** Initialize ePWM2 modules ***/
  {
    ...
    EPwm2Regs.TBPRD = 50U;             // Time Base Period Register
    ...
    EPwm2Regs.CMPA.bit.CMPA = 12U;     // Counter Compare A Register
    EPwm2Regs.CMPB.bit.CMPB = 37U;     // Counter Compare B Register
    EPwm2Regs.CMPC = 25U;              // Counter Compare C Register
    EPwm2Regs.CMPD = 25U;              // Counter Compare D Register
    ...
    /*	// Dead-Band Generator Control Register
       ...
       EPwm2Regs.DBCTL.bit.HALFCYCLE            = 1U;          // Half Cycle Clocking Enable
     ...
     */
    EPwm2Regs.DBCTL.all = (EPwm2Regs.DBCTL.all & ~0x8FFFU) | 0x800BU;
    EPwm2Regs.DBRED.bit.DBRED = (uint16_T)(2.4);
                         // Dead-Band Generator Rising Edge Delay Count Register
    EPwm2Regs.DBFED.bit.DBFED = (uint16_T)(2.4);
    ...
    /*	// Event Trigger Selection and Pre-Scale Register
       ...
       EPwm2Regs.ETSEL.bit.INTEN                = 1U;          // EPWM2INTn Enable
       EPwm2Regs.ETSEL.bit.INTSELCMP            = 0U;
       EPwm2Regs.ETSEL.bit.INTSEL               = 5U;          // Start of Conversion A Select
       EPwm2Regs.ETPS.bit.INTPSSEL              = 1U;          // EPWM2INTn Period Select
       EPwm2Regs.ETINTPS.bit.INTPRD2            = 1U;
     */
    EPwm2Regs.ETSEL.all = (EPwm2Regs.ETSEL.all & ~0xFF7FU) | 0x110DU;
    ...
    /*-- Initial HRPWM for ePWM2 --*/
    {
      ...
      uint16_T CMPBHR = 0;
      uint16_T HRLOADB = 0U;
      uint16_T CTLMODEB = 0U;
      uint16_T EDGMODEB = 3U;
      uint16_T EDGMODEDB = 0;
      uint16_T DBREDHR = 0;
      uint16_T DBFEDHR = 0;
      uint16_T LOADREDMODE = 4U;
      uint16_T LOADFEDMODE = 4U;
      ...
      init_HRPWM ( &EPwm2Regs, HRLOAD, CTLMODE, EDGMODE, CMPAHR, TBPHSHR,
                  TBPRDHR, HPREIdx, AUTOCONV, HRUPDOWN, HRLOADB, CTLMODEB,
                  EDGMODEB, CMPBHR, DBREDHR, DBFEDHR, EDGMODEDB, LOADREDMODE,
                  LOADFEDMODE);
    }
  }
  ...
  /*** Initialize ePWM3 modules ***/
  {
     ...
     */
    EPwm3Regs.TBCTL.all = (EPwm3Regs.TBCTL.all & ~0x3FFFU) | 0x36U;
    EPwm3Regs.TBCTL2.all = (EPwm3Regs.TBCTL2.all & ~0xF000U) | 0x0U;

    /*-- Setup Time-Base (TB) Submodule --*/
    EPwm3Regs.TBPRD = 50U;             // Time Base Period Register
    ...
    EPwm3Regs.CMPA.bit.CMPA = 12U;     // Counter Compare A Register
    EPwm3Regs.CMPB.bit.CMPB = 37U;     // Counter Compare B Register
    EPwm3Regs.CMPC = 25U;              // Counter Compare C Register
    EPwm3Regs.CMPD = 25U;              // Counter Compare D Register
    ...
    /*	// Dead-Band Generator Control Register
       ...
       EPwm3Regs.DBCTL.bit.HALFCYCLE            = 1U;          // Half Cycle Clocking Enable
     ...
     */
    EPwm3Regs.DBCTL.all = (EPwm3Regs.DBCTL.all & ~0x8FFFU) | 0x800BU;
    EPwm3Regs.DBRED.bit.DBRED = (uint16_T)(2.4);
                         // Dead-Band Generator Rising Edge Delay Count Register
    EPwm3Regs.DBFED.bit.DBFED = (uint16_T)(2.4);
                        // Dead-Band Generator Falling Edge Delay Count Register
    ...
    /*	// Event Trigger Selection and Pre-Scale Register
       ...
       EPwm3Regs.ETSEL.bit.INTEN                = 1U;          // EPWM3INTn Enable
       EPwm3Regs.ETSEL.bit.INTSELCMP            = 0U;
       EPwm3Regs.ETSEL.bit.INTSEL               = 5U;          // Start of Conversion A Select
       EPwm3Regs.ETPS.bit.INTPSSEL              = 1U;          // EPWM3INTn Period Select
       EPwm3Regs.ETINTPS.bit.INTPRD2            = 1U;
     */
    EPwm3Regs.ETSEL.all = (EPwm3Regs.ETSEL.all & ~0xFF7FU) | 0x110DU;
  ...
  /*** Initialize ePWM1 modules ***/
  {
    ...
    /*-- Setup Time-Base (TB) Submodule --*/
    EPwm1Regs.TBPRD = 100U;            // Time Base Period Register
    ...
    EPwm1Regs.CMPA.bit.CMPA = 50U;     // Counter Compare A Register
    EPwm1Regs.CMPB.bit.CMPB = 50U;     // Counter Compare B Register
    EPwm1Regs.CMPC = 50U;              // Counter Compare C Register
    EPwm1Regs.CMPD = 50U;              // Counter Compare D Register
    ...
    EPwm1Regs.DBRED.bit.DBRED = (uint16_T)(1.2);
                         // Dead-Band Generator Rising Edge Delay Count Register
    EPwm1Regs.DBFED.bit.DBFED = (uint16_T)(1.2);
                        // Dead-Band Generator Falling Edge Delay Count Register
...
void TestBlink_configure_interrupts(void)
{
  ...
  HWI_TIC28x_ConfigureIRQ(50,&EPWM3_INT,1);
  HWI_TIC28x_EnableIRQ(50);

  /* Register interrupt service routine */
  HWI_TIC28x_ConfigureIRQ(49,&EPWM2_INT,1);
  HWI_TIC28x_EnableIRQ(49);
}
...
interrupt void EPWM3_INT(void)
{
  ...
  /* Event: ePWM event */
  /* Check event ePWM event occurred */
  if (0 != (EPwm3Regs.ETFLG.bit.INT==1)) {
    /* Clear occurred ePWM event event */
    EALLOW;
  ...
  PieCtrlRegs.PIEIER3.all = PIEIER3_stack_save;
                                   /*restore PIEIER register that was modified*/
  HWI_TIC28x_AcknowledgeIrq(50);
}

/* Hardware Interrupt Block: '<S6>/Hardware Interrupt' */
interrupt void EPWM2_INT(void)
{
  ...
  /* Event: ePWM event */
  /* Check event ePWM event occurred */
  if (0 != (EPwm2Regs.ETFLG.bit.INT==1)) {
    /* Clear occurred ePWM event event */
    EALLOW;
  ...
  PieCtrlRegs.PIEIER3.all = PIEIER3_stack_save;
                                   /*restore PIEIER register that was modified*/
  HWI_TIC28x_AcknowledgeIrq(49);
}

void TestBlink_unconfigure_interrupts (void)
{
  HWI_TIC28x_DisableIRQ(50);
  HWI_TIC28x_DisableIRQ(49);
}
